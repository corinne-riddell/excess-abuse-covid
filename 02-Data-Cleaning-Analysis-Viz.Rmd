...
ggplot(Weekly.Data, aes(x = mean_value)) + 
  geom_density() +
  facet_wrap(~abuse_type, scales = "free_x") + 
  geom_rug() + 
...
```{r}
#Krista: can you incorporate this code into the previous code chunk and
#save the plots for each of the three outcomes?
...
plot2 + plot3 + plot_layout(nrow = 2) 
```
