...
for (i in unique(Weekly.Data$abuse_type)) {
  ...
  Weekly_Excess_Searches <- bind_rows(Weekly_Excess_Searches, tmp.w) #this line throws an error tmp.w not found
  
  Abuse.i.Monthly <- bind_cols(Abuse.i.Monthly, Monthly_pred)
  Monthly_Excess_Searches <- bind_rows(Monthly_Excess_Searches, tmp.m) # this line throws an error tmp.m not found
